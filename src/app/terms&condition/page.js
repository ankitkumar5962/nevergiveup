            ...
            <div className="col-span-4 sm:col-span-9  mx-auto">
                <div className="bg-white shadow  p-6 m-auto">
                    ...
                    <div className="mb-6">
                        ...
                        For further inquiries, feedback, or support, please don't hesitate to reach out to us at  <Link href={"/contactus"} className="font-bold text-[19px] text-[#27AB61]">Contact Us</Link>.
                        </p>
                    </div>
