  ...
  return (
    <>
      <section class="text-gray-800 bg-white body-font">
        ...
        <div class="w-24 h-96 bg-indigo-500"></div>
      </div> */}
        ...
        <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">Street art subway tile salvia four dollar toast bitters selfies quinoa yuccie synth meditation iPhone intelligentsia prism tofu. Viral gochujang bitters dreamcatcher.</p>
          ...
          <div class=" flex flex-wrap sm:-m-4 -mx-5 -mb-10 -mt-4">
            <div
              data-aos="zoom-in"
            ...
            >
              ...
              <h2 class="text-xl font-medium  text-black mt-5 font-tittle">
                Educational empowerment
              </h2>
              <p class="text-base leading-relaxed mt-2 font-tittle font-normal">
