            ...
            <div className="col-span-4 sm:col-span-9  mx-auto">
                <div className="bg-white shadow  p-6 m-auto">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="mt-2">
                        In a world plagued by injustice and inequality, we stand as advocates for change. Whether it's addressing legal issues faced by marginalized communities or advocating for their rights, we are committed to fostering a more just and equitable society. Through our legal aid programs, we offer guidance and support to those navigating complex legal systems, ensuring that everyone has access to justice.
                        </p>
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <p className="mt-2 ">
                        At Meera Foundation, we believe that together, we can make a meaningful impact on the lives of those in need. Whether through volunteering, donations, or spreading awareness, we invite you to join us on our journey towards creating a more compassionate and inclusive world. Together, let's build a future where every individual has the opportunity to thrive, regardless of their circumstances.
                        </p>
                    </div>
