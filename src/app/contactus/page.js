        ...
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
              ...
              <h2 class="font-heading mb-4 font-bold tracking-tight text-[#27AB61] text-[#27AB61] text-3xl sm:text-5xl font-tittle">
                  ...
                  <li class="flex">
                    <div class="flex h-10 w-10 items-center justify-center rounded  text-gray-50">
                      <svg
                        ...
                        class="h-full w-full  bg-[#27AB61] p-2 rounded-md"
                      >
                  ...
                  <li class="flex">
                    <div class="flex h-10 w-10 items-center justify-center rounded  text-gray-50">
                      <svg
                        ...
                        class="h-full rounded-md w-full  bg-[#27AB61] p-2 "
                      >
